...
namespace StronglyTypedIds.Utils
{
    ...
    public static class IdUtils
    {
        ...
        /// <summary>
        /// Представляет перечисление экземпляров сущности <typeparamref name="TEntity"/> в виде перечисления <see cref="IdFor{TEntity, TKey}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Представляет перечисление экземпляров <see cref="IdFor{TEntity, TKey}"/> в виде перечисления базовых идентификаторов.
        /// </summary>
